import math
logfile = open('../Corrections/6-TScyc-MN15-THF.log', 'r')
...
logfile = open('common/values50.txt', 'r')
...
print("delta G old:" ,deltaGold/1000 , "Kcal/mol")
print("delta G 50:", deltaGv50/1000 , "Kcal/mol")
print("delta G v:",deltaGv/1000 , "Kcal/mol")
print("delta E:",deltaE/1000 , "Kcal/mol")
